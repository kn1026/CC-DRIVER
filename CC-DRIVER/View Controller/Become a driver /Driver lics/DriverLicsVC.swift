...
class DriverLicsVC: UIViewController, UINavigationControllerDelegate {
    ...
    @IBOutlet weak var driverLicImg: UIImageView!
    ...
    override func viewDidLoad() {
        ...
        if DriverLicImg != nil {
            ...
            driverLicImg.image = DriverLicImg
    ...
    @IBAction func cameraBtnPressed(_ sender: Any) {
        ...
        let sheet = UIAlertController(title: "Upload our driver license", message: "", preferredStyle: .actionSheet)
    ...
    @IBAction func DoneBtnPressed(_ sender: Any) {
        ...
        DriverLics = true
        DriverLicImg = driverLicImg.image
        self.dismiss(animated: true, completion: nil)
        
    }
}

extension DriverLicsVC: UIImagePickerControllerDelegate {
