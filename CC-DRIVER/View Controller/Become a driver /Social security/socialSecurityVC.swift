...
class socialSecurityVC: UIViewController, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        if socialSecurityImg != nil {
            
            previewView.isHidden = false
            ssImage.image = socialSecurityImg
    ...
    @IBAction func cancelBtn1Pressed(_ sender: Any) {
    ...
    @IBAction func DoneBtnPressed(_ sender: Any) {
        ...
        socialSecurity = true
        socialSecurityImg = ssImage.image
...
extension socialSecurityVC: UIImagePickerControllerDelegate {
